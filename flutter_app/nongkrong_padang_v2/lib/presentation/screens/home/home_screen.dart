...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadUser() async {
    ...
    setState(() {
      _userName = info['nama'] ?? 'Pengguna';
      _userRole = info['role'] ?? 'user';
    });
  }
  ...
  Widget _buildTempatCard(RekomendasiItem item) => GestureDetector(
        onTap: () => context.push('/detail/${item.idTempat}'),
        child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _sentimenChip(
                            'Suasana', item.profilSentimen.suasanaPos),
                        const SizedBox(width: 6),
                        _sentimenChip('Harga', item.profilSentimen.hargaPos),
                        const SizedBox(width: 6),
                        _sentimenChip(
                            'Fasilitas', item.profilSentimen.fasilitasPos),
                      ],
                    ),
                  ],
                ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                'Sistem sedang menyiapkan data tempat terbaik untukmu. Pastikan koneksi internet lancar.',
